...
function CedisScreen({ ai }) {
  ...
  const [proveedores, setProveedores] = useState([
    { id:1, nombre:"La Barca", medias:[], pesoEsperado:0, pesoReal:0, mermaCalc:0 },
    { id:2, nombre:"Maldonado", medias:[], pesoEsperado:0, pesoReal:0, mermaCalc:0 },
    { id:3, nombre:"David Sanches", medias:[], pesoEsperado:0, pesoReal:0, mermaCalc:0 },
    { id:4, nombre:"Everardo Sánchez", medias:[], pesoEsperado:0, pesoReal:0, mermaCalc:0 },
  ]);
  ...
  return (
    <div style={{ padding:"22px" }}>
      ...
      <div style={{ marginTop:24, display:"flex", gap:10, alignItems:"center" }}>
        ...
        <button onClick={()=>{ if(nuevoProv.trim()) { setProveedores(ps=>[...ps, { id:Date.now(), nombre:nuevoProv, medias:[], pesoEsperado:0, pesoReal:0 }]); setNuevoProv(""); } }}
